...
import { CheckCircle, Copy, Phone, Clock, CreditCard, Plane, Share2, Plus, Search, FileText, Heart } from 'lucide-react';
import { useRouter } from 'next/navigation';

const ShipmentSuccessPage = () => {

  const {ship, expetTime, Price, Bill, Total, Taks} = useCalc()
 ...
 <div className="z-10 bg-white p-2 flex flex-col items-center gap-2">
      ...
      <div className="max-w-5xl mx-auto mt-12 flex flex-wrap items-center justify-center gap-4">
        ...
        <button onClick={() => router.replace("/new-shipment")} className="flex-1 cursor-pointer min-w-[200px] py-4 bg-white text-orange-600 rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-orange-50 transition-all border border-orange-100">
          <Plus size={20} />
          شحنة جديدة
        </button>
